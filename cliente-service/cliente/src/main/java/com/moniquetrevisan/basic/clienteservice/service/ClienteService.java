...
public class ClienteService {
	...
	public Cliente findClienteByClienteId(Integer clienteId) {
		return repository.findClienteByClienteId(clienteId, StatusDefaults.CLIENTE_INATIVO);
	}

	public Cliente findClienteByEmail(String email) {
		return repository.findClienteByEmail(email, StatusDefaults.CLIENTE_INATIVO);
	}
